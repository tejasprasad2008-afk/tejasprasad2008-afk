...
- 🕷️ **Supply chain security** — behavioral analysis, syscall tracing, ML anomaly detection
...
### 🕸️ [TraceTree](https://github.com/tejasprasad2008-afk/TraceTree)
...
### 🎙️ [lumina-studios](https://github.com/tejasprasad2008-afk/lumina-studios)
![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
...
| MoE TTS Routing Architecture | In progress | ML infrastructure |
| Cascaded Vessel Monitoring (CVM) + DVTP with ZK-Proofs | Under review | Maritime AIS spoofing, cyber-physical security |
...
- **X / Twitter:** [@tejxs_ish](https://x.com/tejxs_ish)
